...
public class IncomesReport extends FormPanel {
	 ...
	 * Create the panel.
	 */
	public IncomesReport(JFrame frame,JPanel panelback) {
		super(frame,panelback);
		title.setText("Incomes Report");
		path.setText("Login/Administrator Window/Watch Quarterly Reports/Incomes Report");
