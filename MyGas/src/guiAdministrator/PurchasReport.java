...
public class PurchasReport extends FormPanel {
	 ...
	 * Create the panel.
	 */
	public PurchasReport(JFrame frame,JPanel panelback) {
		super(frame,panelback);
		title.setText("Purchase Report");
		path.setText("Login/Administrator Window/Watch Quarterly Reports/Purchase Report");
